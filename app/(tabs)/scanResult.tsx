...
type HistoryItem = {
  ...
  title: string;
  ingredients: string;
  checkedAt: string; // texto simples "Checked 1 day ago"
  hasAlert: boolean;
  matched?: string[];
};
...
export default function ScanResultScreen() {
  ...
  // ✅ histórico fake (15 itens) só pra layout/integrar
  const mockHistory = useMemo<HistoryItem[]>(() => {
    const items: HistoryItem[] = [
      ...
      },
      {
        ...
        ingredients: "rice flour, yeast, salt",
        checkedAt: "Checked 3 days ago",
        hasAlert: false,
      },
      {
        id: "h4",
        title: "Chocolate Cookies",
        ingredients: "wheat, milk, soy lecithin",
        checkedAt: "Checked 4 days ago",
        hasAlert: true,
        matched: ["Gluten", "Milk", "Soy"],
      },
      {
        id: "h5",
        title: "Yogurt",
        ingredients: "milk, cultures",
        checkedAt: "Checked 5 days ago",
        hasAlert: true,
        matched: ["Milk"],
      },
      {
      ...
      },
      {
        id: "h9",
        title: "Fish Sticks",
        ingredients: "fish, wheat, oil",
        checkedAt: "Checked 9 days ago",
        hasAlert: true,
        matched: ["Fish", "Gluten"],
      },
      {
        id: "h10",
        title: "Shrimp Salad",
        ingredients: "shrimp, mayo, lemon",
        checkedAt: "Checked 10 days ago",
        hasAlert: true,
        matched: ["Shellfish"],
      },
      {
        id: "h11",
        title: "Granola Bar",
        ingredients: "nuts, oats, honey",
        checkedAt: "Checked 11 days ago",
        hasAlert: true,
        matched: ["Tree Nuts"],
      },
      {
      ...
      },
      {
        ...
        checkedAt: "Checked 15 days ago",
        hasAlert: true,
        matched: ["Gluten", "Milk", "Eggs"],
      },
    ];

    // opcional: colocar o payload atual no topo como “Latest”
  ...
  return (
    <View style={styles.page}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {/* Debug (integration) - sem PhotoUri */}
          ...
          {mockHistory.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* ✅ seta por registro (vai pro history) */}
                <Pressable
                  onPress={() => goToHistory(item.id)}
                  hitSlop={10}
