...
export default function SignUpScreen() {
  ...
  return (
    <View style={styles.page}>
      <View style={[styles.phoneFrame, isWeb && { width: phoneW, height: phoneH, borderRadius: 26 }]}>
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.form}>
              ...
              <TextInput value={email} onChangeText={setEmail} placeholder="Email ID" placeholderTextColor="rgba(255,255,255,0.35)" autoCapitalize="none" keyboardType="email-address" style={styles.input} />
              <TextInput value={pass} onChangeText={setPass} placeholder="Password" placeholderTextColor="rgba(255,255,255,0.35)" secureTextEntry style={styles.input} />
...
const styles = StyleSheet.create({
  ...
  phoneFrame: { flex: 1, width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#171A1F" },
  scroll: { flexGrow: 1, paddingHorizontal: 22, paddingTop: 16, paddingBottom: 28 },
  ...
  input: { height: 46, borderRadius: 12, borderWidth: 1.4, borderColor: "#4AB625", paddingHorizontal: 14, color: "#fff", marginBottom: 12, backgroundColor: "#171A1F" },
  bottomArea: { marginTop: "auto", paddingTop: 8, paddingBottom: 6 },
  primaryBtn: { backgroundColor: "#4AB625", borderRadius: 16, paddingVertical: 16, alignItems: "center", justifyContent: "center", marginBottom: 18 },
  ...
  socialBtn: { width: 58, height: 58, borderRadius: 999, backgroundColor: "#FFF", borderWidth: 1, borderColor: "#FFF", alignItems: "center", justifyContent: "center" },
